...
nmap ; :Denite buffer -start-filter -split=floating -winrow=1<CR>
nmap <leader>t :Denite file/rec -start-filter -split=floating -winrow=1<CR>
nnoremap <leader>g :<C-u>Denite grep:. -no-empty -start-filter -split=floating -winrow=1<CR>
nnoremap <leader>j :<C-u>DeniteCursorWord grep:. -start-filter -split=floating -winrow=1 <CR>
